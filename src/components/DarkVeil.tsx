...
export default function DarkVeil({
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({
      ...
      canvas,
      alpha: !whiteBackground, // NEW
    });
    const gl = renderer.gl as unknown as WebGLRenderingContext;

    if (whiteBackground) {
      gl.clearColor(1, 1, 1, 1);      // ⬅️ pure white clear
      // optional safety: canvas.style.background = "#fff";
    }
    ...
    const loop = () => {
      ...
      program.uniforms.uTime.value = ((performance.now() - t0) / 1000) * effectiveSpeed;
